<template>
  <div class="dark-bgc">
    <div class="dark-bgc p-2 grid mt-3">
      ...
      >
      <form class="grid grid-cols-3 items-center justify-start p-1">
        <div class="flex-form">
        ...
        <div class="flex-form">
          <label for="expectedSalary"> Wyngarodzenie </label>
          <input
            id="expectedSalary"
            class="dark-bgc2 px-1 py-1"
            v-model="editedUser.expectedSalary"
            placeholder="Wyngarodzenie"
            type="number"
          />
        </div>
        <div class="flex-form">
        ...
        <div class="flex-form">
          <label for="courseCompletion"> Ocena stopnia przejścia kursu </label>
          <input
            id="courseCompletion"
            class="dark-bgc2 px-1 py-1"
    ...
    <div class="flex-center">
      <button @click.prevent="submitForm()" class="add-button px-32 mt-4 mb-10">
